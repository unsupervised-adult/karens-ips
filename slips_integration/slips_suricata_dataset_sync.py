    ...
    def _init_datasets(self):
        ...
        if not os.path.exists(self.slips_blocked_dataset):
            with open(self.slips_blocked_dataset, 'w') as f:
                f.write('# SLIPS Behavioral Analysis Blocked IPs\n')
                f.write('# Format: base64 encoded IPv4 addresses\n')
                f.write('# Auto-generated by slips_suricata_dataset_sync.py\n')
        
        if not os.path.exists(self.suricata_detected_dataset):
            with open(self.suricata_detected_dataset, 'w') as f:
                f.write('# Suricata Signature-Detected Malicious IPs\n')
                f.write('# Format: base64 encoded IPv4 addresses\n')
                f.write('# Auto-generated by slips_suricata_dataset_sync.py\n')
